...
#     factor4 = G
#
#   The original factor theta_CV is removed from the experimental design and
#   is not written to the design matrix or design legend.
#
...
build_hake_factorial_design_matrix_from_spec <- function(
  ...
  desired_order <- c(
    ...
    "factor4", "level4_code",
    "K", "G", "h", "theta_true", "Nmin", "Nmax", "nsims",
...
build_hake_factorial_design_matrix <- function(
  ...
  cat("The theta_CV factor has been removed from the design.\n")
