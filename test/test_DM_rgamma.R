# file = test_DM_rgamma.R
# test_DM_rgamma.R applies the functional analysis tool to a set
...
# Manually sample from a Dirichlet multinomial using gamma distributions
set.seed(26267)
