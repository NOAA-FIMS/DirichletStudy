...
## Output files:
##  - CSV: "hake_ev1.csv"
##  - Plots: "rmse_i_ev1.png","rmse_ii_ev1.png", "rmse_iii_ev1.png"
##           and "rmse_iv_ev1.png"
##  - List: "hake_ev1.lst"
##
...
run_one <- function(p_true,N_row) {
  ...
  for (g in 1:G) {
    ...
    kappa_g <- kappa  # from hake_ev1.inp; smaller = more variation
...
p_hat_i     <- alpha_hat_i / sum(alpha_hat_i)
  ...
  c(p_true,rmse_i,rmse_ii,rmse_iii,rmse_iv)
}
...
ggsave("rmse_i_ev1.png", p_i, width = 6, height = 5, dpi = 300)
ggsave("rmse_ii_ev1.png", p_ii, width = 6, height = 5, dpi = 300)
ggsave("rmse_iii_ev1.png", p_iii, width = 6, height = 5, dpi = 300)
ggsave("rmse_iv_ev1.png", p_iv, width = 6, height = 5, dpi = 300)
