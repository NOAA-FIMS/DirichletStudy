# summarize_hake_lst_files_multinomial_om.R
# Build a compact summary from ex1...ex243/*.lst files
...
# Find all .lst files under ex1...ex243
...
write.csv(summary_df, "hake_243_experiment_summary.csv", row.names = FALSE)
...
cat("Wrote:\n")
cat("  hake_243_experiment_summary.csv\n")
