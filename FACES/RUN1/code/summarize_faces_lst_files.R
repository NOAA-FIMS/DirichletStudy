...
write.csv(summary_df, "run1_summary.csv", row.names = FALSE, na = "")
write.csv(
  make_frequency_table(summary_df, "rmse_best"),
  "run1_rmse_best_frequency.csv",
  row.names = FALSE
)
write.csv(
  make_frequency_table(summary_df, "l1_best"),
  "run1_l1_best_frequency.csv",
  row.names = FALSE
)
write.csv(
  make_frequency_table(summary_df, "linf_best"),
  "run1_linf_best_frequency.csv",
  row.names = FALSE
)
write.csv(
  distance_correlations,
  "run1_distance_correlations.csv",
  row.names = FALSE,
  na = ""
)

cat("Wrote:\n")
cat("  run1_summary.csv\n")
cat("  run1_rmse_best_frequency.csv\n")
cat("  run1_l1_best_frequency.csv\n")
cat("  run1_linf_best_frequency.csv\n")
cat("  run1_distance_correlations.csv\n")
