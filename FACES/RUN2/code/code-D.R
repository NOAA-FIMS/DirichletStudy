...
#
# Optional controls:
#   Sys.setenv(CODE_D_MAX_ROWS = "500000")
...
run_code_D <- function(data_name = "acc_long",
                        out_file = "results-code-D.txt") {

  max_rows <- suppressWarnings(as.integer(
    Sys.getenv("CODE_D_MAX_ROWS", unset = "500000")
  ))
  ...
  tryCatch({
    ...
    fwrite(summary_rows, "results-code-D-summary.csv")

    cat("Analysis completed successfully.\n")
    cat("Saved detailed results: results-code-D.rds\n")
    cat("Saved MANOVA summary: results-code-D-summary.csv\n")
